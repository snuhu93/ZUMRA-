  ...
  return (
    <div className="flex min-h-dvh flex-col bg-gradient-to-b from-brand-700 via-brand-600 to-brand-800 safe-top">
      ...
      <div className="flex flex-col items-center justify-center px-6 pt-16 pb-10">
        <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-white/15 backdrop-blur-sm shadow-2xl ring-1 ring-white/20 animate-scale-in">
          <span className="font-display text-5xl font-bold text-white">Z</span>
        </div>
        <h1 className="font-display text-4xl font-bold tracking-tight text-white animate-fade-in">ZUMRA</h1>
        <p className="mt-2 text-center text-brand-100 animate-fade-in">Connect. Share. Belong.</p>
      </div>

      {/* Form card */}
      <div className="flex-1 rounded-t-3xl bg-white px-6 pt-8 animate-slide-up">
        <h2 className="font-display text-2xl font-bold text-slate-800">Welcome back</h2>
        <p className="mt-1 text-sm text-slate-500">Sign in to continue to ZUMRA</p>
